    ...
    <div class="main-container">
            ...
            <ul class="slides">
                <li class="image-bg pt-xs-240 pb-xs-240">
                    <div class="background-image-holder">
                        <img alt="PhuocSonHotel Superior Room" class="background-image" src="img/a1.jpg">
                    </div>
                    <div class="align-bottom">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-12 text-center-xs mb-xs-24">
                                <h4 class="uppercase mb0 bold">PhuocSonHotel</h4>
                                <span>Top Ranked Value Mini-Hotel in Hue</span>
                            </div>
                            <div class="hidden-sm hidden-xs col-md-6">
                                <p>
                                    ...
                                    views of the Pagoda or University. 179 Tran Phu,  Hue, Vietnam,
                                    0968 224 048</p>
                            </div>
                ...
                <li class="image-bg pt-xs-240 pb-xs-240">
                    <div class="background-image-holder">
                        <img alt="Hue PhuocSonHotel, Mekong Vietnam, Front Desk" class="background-image"
                    ...
                    <div class="align-bottom">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xs-12 text-right text-center-xs col-md-3">
                                <a class="btn btn btn-white mt16 btn-filled" href="{{ route('orders') }}"
                ...
                <li class="image-bg pt-xs-240 pb-xs-240">
                    <div class="background-image-holder">
                        <img alt="PhuocSonHotel, Hue, Mekong Delta, Vietnam" class="background-image"
        ...
        <section>
            ...
            <div class="container">
                <div class="row v-align-children">
                    <div class="col-sm-5">
                        <h3>Book a Room at PhuocSonHotel</h3>
                        ...
                        <div class="overflow-hidden mb32 mb-xs-24">
                            ...
                            <h6 class="uppercase mb0 inline-block p32">Top Ranked Value Hotel in Hue City</h6>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="pricing-table pt-1 text-center emphasis">
                            ...
                            <a class="btn btn-white btn-lg" href="{{ route('orders') }}" target="_blank">Book Now</a>
                            <p>
                                <a href="/cdn-cgi/l/email-protection#f0999e969fb0989f84959c889f9199de939f9d"
                                    target="_self">Contact Us for</a>
                                <br> large group bookings&nbsp;<br>0968 224 048<br><br><br>
                            </p>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-5 col-md-offset-1 col-sm-6 mb40 mb-xs-24">
                        ...
                        <p style="color: #fff">PhuocSonHotel opened 2012 as a family-run value mini-hotel. The
                            ...
                            concept of PhuocSonHotel is "no frills, but clean and relaxed".</p>
                    </div>
                    <div class="col-md-5 col-sm-6 mb40 mb-xs-24">
                        ...
                        <p style="color: #fff">At PhuocSonHotel we want to provide a good service at a fair price for
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-1">
                        <div class="feature bordered">
                            ...
                            <a class="btn btn-lg btn-filled" href="{{ route('orders') }}" target="_blank">Book A
                                Room</a>
                        </div>
                    </div>
                    <div class="col-sm-5">
        ...
        <section class="image-slider slider-all-controls controls-inside pt0 pb0 height-70 parallax">
            <ul class="slides">
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="Roof bar Hue PhuocSonHotel" class="background-image" src="img/IMG_01971.JPG">
                    </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <p class="lead mb40">The Roof Terrace on the sixth floor is the place to relax, have a
                                    ...
                                    time.</p>
                                <a class="btn btn-lg" href="{{ route('orders') }}" target="_blank">CALL 096 8224 048</a>
                                <a class="btn btn-lg btn-filled" href="{{ route('orders') }}" target="_blank">Book a
                                    ROOM</a>
                            </div>
                        </div>
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="View from Hue PhuocSonHotel" class="background-image" src="img/IMG_01911.JPG">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row text-center">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <p class="lead mb40">Enjoy a fresh breeze on the roof and observe activities on one of
                                    the busiest streets in Hue. Just opposite the hotel you find the Quang Duc
                                    Pagoda. On the roof there are typical plants from Vietnam. <br>Do you recognize
                                    which trees are Mango trees?</p>
                                <a class="btn btn-lg btn-filled" href="{{ route('orders') }}" target="_blank">Call 0968
                                    224 048</a>
                                <a class="btn btn-lg" href="{{ route('orders') }}" target="_blank">Book a Room</a>
                            </div>
                        </div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h4 class="uppercase mb16">PhuocSonHotel Gallery</h4>
                        <p class="lead mb64">
                            Impressions</p>
                    </div>
                </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="img/2013_01_25_s100_291.jpg" data-lightbox="Gallery"
                                        data-title="Bathroom Hue PhuocSonHotel">
                                        <div class="background-image-holder fadeIn">
                                            <img alt="Bathroom Hue PhuocSonHotel" class="background-image"
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <p class="lead mb40 mb-xs-24">
                            ...
                            mini hotel.&nbsp;<br>Our address is:&nbsp;<br><br>PhuocSonHotel Hue&nbsp;<br>179 Tran Phu
                            Street&nbsp;<br>95000 Hue
                            City&nbsp;<br>Vietnam&nbsp;<br>Email:soncaodarkin3@gmail.com&nbsp;<br>CALL 0968 224
                            048<br></p>
                        <a class="btn btn-filled btn-lg mb0" href="{{ route('orders') }}" target="_blank">Book
                            Online</a>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row v-align-children">
                    <div class="col-sm-6 col-md-5">
                        <h2 class="uppercase color-primary">The Perfect Place To Stay In Hue</h2>
                        <hr>
                        <p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-7">
                        <p>
                            The Hue Hotel welcomes International travelers since 2012 and we are working hard to
                            make every guests' stay as comfortable as possible. Our family hotel is the top ranked value
                            hotel in Hue city. We offer small and comfortable rooms, a beautiful roof terrace and a
                            wholehearted service. One of our slogans is fair and friendly service for a fair price.</p>

                        <p>
                            The hotel is located in the Xuan Khanh quarter in vicinity to Hue University, the Tham
                ...
                <div class="feed-item mb96 mb-xs-48">
                    <div class="row mb16 mb-xs-0">
                        <div class="col-md-offset-2 col-sm-10 col-sm-offset-1 text-center col-md-9">
                            ...
                            <h3>Food Tours and Floating Market Tours in Hue</h3>
                        </div>
                    </div>

                    <div class="row mb32 mb-xs-16">
                        <div class="col-md-offset-2 col-sm-10 col-sm-offset-1 col-md-9">
                            <img alt="Floating Market in Hue" class="mb32 mb-xs-16" src="img/floatingmarket.jpg">
                            <p class="lead">
                                Enjoy beautiful tours in Hue and the delta with the Mekong Tours Information Bureau.
                                Mekong Tours is your friendly local tour and hotel provider operated from Hue city
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
                            <a class="mb48 mb-xs-32 btn btn-lg btn-filled" href="http://mekongtours.info"
                                target="_blank">Book a Tour in Hue</a>
                            <hr>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-2 col-sm-12 col-md-9">
                        <h4 class="uppercase mb80">How To Get To PhuocSonHotel</h4>
                        <div class="tabbed-content button-tabs">
                            <ul class="tabs">
                                <li class="active">
                                    ...
                                    <div class="tab-content">
                                        <p>Go to Le Hong Phong Street in the center of Ho Chi Minh City. There are
                                            plenty of small bus operators and two big bus operators servicing Hue:
                                            ...
                                            Hue. Please tell him the name of the hotel and hand him the address (most
                                            ...
                                            in another area or drives around the city. The address: PhuocSonHotel, 179
                                            Le Hong Phong Street, 0968 224 048.&nbsp;The charge should be in any
                                            ...
                                            Khanh'. This is the longest street of the Mekong Delta and the
                                ...
                                <li>
                                    ...
                                    <div class="tab-content">
                                        <p>Many bus companies operate in the Mekong Delta. The major bus companies will
                                            have a service to bring you directly to your destination in Hue. Please
                                            hand the driver the address and telephone number of the hotel and he/she
                                            will take care to put you off at the hotel: PhuocSonHotel, 179 Tran Phu,
                                            0968 224 048.&nbsp;<br><br>There are two main bus stations
                                            in Hue. If you happen not to get a ride directly to the hotel, please
                                ...
                                <li>
                                    ...
                                    <div class="tab-content">
                                        <p>
                                            Hue has a new and very modern airport. The first flight services
                                            ...
                                            hotel:&nbsp;PhuocSonHotel,&nbsp;179 Tran Phu, &nbsp;0921 277
            ...
            <div class="container">
                ...
                <div class="row mb160 mb-xs-0">
                    <div class="col-md-6 col-sm-8">
                        <p class="lead">
                            Family hotel Hotel Hue is the top ranked value hotel in Hue city. We offer small and
        ...
        <footer class="footer-1 bg-secondary">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="widget">
                            <h6 class="title">More Info on Hue</h6>
                            <hr>
                            <ul class="link-list recent-posts">
                                <li>
                                    <a href="https://s.net.vn/MpXi" target="_blank">HRS Cruise - Huong River Services:
                                        s.net.vn/MpXi</a>

                                </li>
                                <li>
                                    <a href="https://en.wikipedia.org/wiki/Hu%E1%BA%BF" target="_blank">Hue
                                        in the Wikipedia: https://en.wikipedia.org/wiki/Huế</a>
                                ...
                                <li>
                                    <a href="http://www.Hueinfo.com/" target="_blank">Hue Information Portal
                                        Hueinfo.com</a>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <span class="sub" style="color: #fff">PhuocSonHotel Hue |&nbsp;179 Tran Phu,
                            95000 Hue City, Vietnam<br>Web PhuocSonHotel.com &nbsp;| Email <a
                                href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                data-cfemail="c3aaada5ac83abacb7a6afbbaca2aaeda0acae">soncaodarkin3@gmail.com</a><br>Phone
                            0968 224 048 </span>
                    </div>
