...
@section('content')
    <section class="sheet padding-10mm">
        <article>
            <table border="0" align="center" cellspacing="0">
                <tr>
                    <td class="companyInfo">
                        Công ty Hotel Phuoc Son<br />
                        phuocsonhotel.com<br />
                        092 127 7127<br />
            ...
            <table border="1" align="center" cellpadding="5">
                ...
                @foreach ($db as $p)
                    <tr>
                        ...
                        <td align="center">
                            <img class="hinhSanPham" src="{{ asset('/storage/photos/' . $p->lp_hinh) }}" width="200"
                                height="200" />
                        </td>
            ...
            <table border="1" align="center" cellpadding="5">
                <tr>
                    <th colspan="6" align="center">Trang {{ 1 + floor(($loop->index + 1) / 5) }} / {{ $tongSoTrang }}
                    </th>
                </tr>
                <tr>
                    <th>STT</th>
